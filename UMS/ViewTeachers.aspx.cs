...
namespace UMS
{
    public partial class ViewTeachers : System.Web.UI.Page
    {
        ...
        public void gvbind()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select * from school.teacher where ID <> 1", con);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("delete FROM school.teacher where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();

            string script = "alert(\"TEACHER DELETED!\");";
