...
namespace UMS
{
    public partial class ViewCourses : System.Web.UI.Page
    {
        ...
        public void gvbind()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select Id,Name as n , Code as c, Semester as s, Teacher as t FROM school.course", con);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("delete FROM school.course where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();

            string script = "alert(\"Course DELETED!\");";
