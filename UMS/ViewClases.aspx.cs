...
namespace UMS
{
    public partial class ViewClases : System.Web.UI.Page
    {
        ...
        public void gvbind()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select ID,SectionName as sn , Class as c , Teacher as t, Strenght as s from school.section Order By Class ASC", con);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("delete FROM school.section where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();

            string script = "alert(\"SECTION DELETED!\");";
